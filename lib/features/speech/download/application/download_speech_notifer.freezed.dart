...
/// @nodoc
class _$DownloadSpeechStateTearOff {
  const _$DownloadSpeechStateTearOff();

  _Initial initial() {
    return const _Initial();
  }

  _Loading loading(double progress) {
    return _Loading(
      progress,
    );
  }
  ...
  _Failure failure(DownloadSpeechFailure failure) {
    return _Failure(
      failure,
    );
  }
...
/// @nodoc
const $DownloadSpeechState = _$DownloadSpeechStateTearOff();
...
abstract class _Loading extends DownloadSpeechState {
  const factory _Loading(double progress) = _$_Loading;
...
abstract class _Failure extends DownloadSpeechState {
  const factory _Failure(DownloadSpeechFailure failure) = _$_Failure;
  const _Failure._() : super._();

  DownloadSpeechFailure get failure;
  @JsonKey(ignore: true)
  _$FailureCopyWith<_Failure> get copyWith =>
      throw _privateConstructorUsedError;
}
